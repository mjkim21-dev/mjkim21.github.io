...
The following table includes requirements for the Gain and Exposure system. You can see the team project requirements [here](https://egr314-s-2026-304.github.io/03-Project-requirements/).
